...
# Page configuration
st.set_page_config(
    page_title="NASA RAG Chat with Evaluation", page_icon="🚀", layout="wide"
)
...
def main():
    ...
    st.markdown(
        "Chat with AI about NASA space missions with real-time quality evaluation"
    )
    ...
    with st.sidebar:
        ...
        enable_evaluation = st.checkbox(
            "Enable RAGAS Evaluation", value=RAGAS_AVAILABLE
        )
